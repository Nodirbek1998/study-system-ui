...
describe('Subjects e2e test', () => {
  ...
  describe('Subjects page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('edit button click should load edit Subjects page', () => {
  ...
  describe('new Subjects page', () => {
    ...
    it('should create an instance of Subjects', () => {
      cy.get(`[data-cy="nameUz"]`).type('Rustic').should('have.value', 'Rustic');

      cy.get(`[data-cy="nameRu"]`).type('programming').should('have.value', 'programming');

      cy.get(`[data-cy="nameEn"]`).type('Chief invoice').should('have.value', 'Chief invoice');
