...
class ArticleResourceIT {
    ...
    public static Article createEntity(EntityManager em) {
        Article article = new Article().name(DEFAULT_NAME).text(DEFAULT_TEXT).createdAt(DEFAULT_CREATED_AT).updatedAt(DEFAULT_UPDATED_AT);
        return article;
    }
    ...
    public static Article createUpdatedEntity(EntityManager em) {
        Article article = new Article().name(UPDATED_NAME).text(UPDATED_TEXT).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
        return article;
    }
    ...
    void putNewArticle() throws Exception {
        ...
        updatedArticle.name(UPDATED_NAME).text(UPDATED_TEXT).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
    ...
    void partialUpdateArticleWithPatch() throws Exception {
        ...
        partialUpdatedArticle.name(UPDATED_NAME).text(UPDATED_TEXT).createdAt(UPDATED_CREATED_AT);
    ...
    void fullUpdateArticleWithPatch() throws Exception {
        ...
        partialUpdatedArticle.name(UPDATED_NAME).text(UPDATED_TEXT).createdAt(UPDATED_CREATED_AT).updatedAt(UPDATED_UPDATED_AT);
