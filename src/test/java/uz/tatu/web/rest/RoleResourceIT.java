...
class RoleResourceIT {
    ...
    public static Role createEntity(EntityManager em) {
        Role role = new Role().nameUz(DEFAULT_NAME_UZ).nameRu(DEFAULT_NAME_RU).nameEn(DEFAULT_NAME_EN);
        return role;
    }
    ...
    public static Role createUpdatedEntity(EntityManager em) {
        Role role = new Role().nameUz(UPDATED_NAME_UZ).nameRu(UPDATED_NAME_RU).nameEn(UPDATED_NAME_EN);
        return role;
    }
    ...
    void createRole() throws Exception {
        ...
        assertThat(testRole.getNameUz()).isEqualTo(DEFAULT_NAME_UZ);
        assertThat(testRole.getNameRu()).isEqualTo(DEFAULT_NAME_RU);
        assertThat(testRole.getNameEn()).isEqualTo(DEFAULT_NAME_EN);
    }
    ...
    void putNewRole() throws Exception {
        ...
        updatedRole.nameUz(UPDATED_NAME_UZ).nameRu(UPDATED_NAME_RU).nameEn(UPDATED_NAME_EN);
        ...
        Role testRole = roleList.get(roleList.size() - 1);
        assertThat(testRole.getNameUz()).isEqualTo(UPDATED_NAME_UZ);
        assertThat(testRole.getNameRu()).isEqualTo(UPDATED_NAME_RU);
        assertThat(testRole.getNameEn()).isEqualTo(UPDATED_NAME_EN);
    }
    ...
    void partialUpdateRoleWithPatch() throws Exception {
        ...
        partialUpdatedRole.nameRu(UPDATED_NAME_RU);
    ...
    void fullUpdateRoleWithPatch() throws Exception {
        ...
        partialUpdatedRole.nameUz(UPDATED_NAME_UZ).nameRu(UPDATED_NAME_RU).nameEn(UPDATED_NAME_EN);
