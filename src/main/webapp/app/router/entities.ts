...
// prettier-ignore
const StudyUsers = () => import('@/entities/study-users/study-users.vue');
// prettier-ignore
const StudyUsersUpdate = () => import('@/entities/study-users/study-users-update.vue');
// prettier-ignore
const StudyUsersDetails = () => import('@/entities/study-users/study-users-details.vue');
// prettier-ignore
  ...
  children: [
    {
      path: 'study-users',
      name: 'StudyUsers',
      component: StudyUsers,
      meta: { authorities: [Authority.USER] },
    },
    {
      path: 'study-users/new',
      name: 'StudyUsersCreate',
      component: StudyUsersUpdate,
      meta: { authorities: [Authority.USER] },
    },
    {
      path: 'study-users/:studyUsersId/edit',
      name: 'StudyUsersEdit',
      component: StudyUsersUpdate,
      meta: { authorities: [Authority.USER] },
    },
    {
      path: 'study-users/:studyUsersId/view',
      name: 'StudyUsersView',
      component: StudyUsersDetails,
      meta: { authorities: [Authority.USER] },
    },
    {
      path: 'role',
