...
export default class SubjectsService {
  public find(id: number): Promise<ISubjects> {
    return new Promise<ISubjects>((resolve, reject) => {
      axios
        .get(`${baseApiUrl}/${id}`)
        .then(res => {
          resolve(res.data);
  ...
  public create(entity: ISubjects): Promise<ISubjects> {
    return new Promise<ISubjects>((resolve, reject) => {
      axios
  ...
  public update(entity: ISubjects): Promise<ISubjects> {
    return new Promise<ISubjects>((resolve, reject) => {
      axios
  ...
  public partialUpdate(entity: ISubjects): Promise<ISubjects> {
    return new Promise<ISubjects>((resolve, reject) => {
      axios
