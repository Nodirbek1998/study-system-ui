  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="studysystemApp.article.home.createOrEditLabel" data-cy="ArticleCreateUpdateHeading">Create or edit a Article</h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" for="article-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
          ...
          <div class="form-group">
            <label class="form-control-label" for="article-text">Text</label>
            <input
              type="text"
              class="form-control"
              name="text"
            ...
            <div v-if="$v.article.text.$anyDirty && $v.article.text.$invalid">
              <small class="form-text text-danger" v-if="!$v.article.text.maxLength">
                This field cannot be longer than 1000 characters.
              </small>
            </div>
          </div>
          <div class="form-group">
            <label class="form-control-label" for="article-createdAt">Created At</label>
          ...
          <div class="form-group">
            <label class="form-control-label" for="article-updatedAt">Updated At</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
          ...
          <div class="form-group">
            <label class="form-control-label" for="article-studyUser">Study User</label>
          ...
          <div class="form-group">
            <label class="form-control-label" for="article-createdBy">Created By</label>
          ...
          <div class="form-group">
            <label class="form-control-label" for="article-updatedBy">Updated By</label>
