  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="studysystemApp.files.home.createOrEditLabel"
          data-cy="FilesCreateUpdateHeading"
          v-text="$t('studysystemApp.files.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('studysystemApp.files.name')" for="files-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('studysystemApp.files.fileSize')" for="files-fileSize">File Size</label>
            <input
              type="number"
              class="form-control"
              name="fileSize"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('studysystemApp.files.contentType')" for="files-contentType">Content Type</label>
            <input
              type="text"
              class="form-control"
              name="contentType"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('studysystemApp.files.createdAt')" for="files-createdAt">Created At</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('studysystemApp.files.createdBy')" for="files-createdBy">Created By</label>
