  ...
  <div>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="studysystemApp.files.delete.question" data-cy="filesDeleteDialogHeading">Confirm delete operation</span></span
      >
      <div class="modal-body">
        <p id="jhi-delete-files-heading">Are you sure you want to delete this Files?</p>
      </div>
