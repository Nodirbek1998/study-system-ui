...
<!--        <button class="btn btn-info mr-2" v-on:click="createExamples" >-->
...
<!--        </button>-->
    ...
    <div class="table-wrapper" >
      ...
      <div class="alert alert-warning" v-if="!isFetching && examplesAnswer && examplesAnswer.length === 0">
    ...
    <div v-show="examplesAnswer && examplesAnswer.length > 0">
...
<script lang="ts" src="./examples-answer.component.ts"></script>
